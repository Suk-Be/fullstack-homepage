import BorderConfiguration from '@/componentsTemplateEngine/gridConfigurations/ui/borderConfiguration';
...
vi.mock(
    '@/componentsTemplateEngine/gridConfigurations/ui/borderConfiguration/StyledCheckbox',
    () => ({
        __esModule: true,
...
vi.mock(
    '@/componentsTemplateEngine/gridConfigurations/ui/ui-shared-comnponents/RangeSlider',
    () => ({
        __esModule: true,
        default: ({
            value,
