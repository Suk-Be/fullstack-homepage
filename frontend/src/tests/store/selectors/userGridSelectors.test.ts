import { selectGridsFromThisUser, selectInitialGrid, selectSavedGridsMap, selectSortedGrids } from '@/store/selectors/userGridSelectors';
...
describe('userGridSelectors', () => {
  ...
  it('selectGridsFromThisUser returns the grids (object keys of savedGrids) in a new array', () => {
    ...
    expect(result).toEqual([
      mockState.userGrid.savedGrids.initial,
      mockState.userGrid.savedGrids.grid2,
    ]);
  });
});
