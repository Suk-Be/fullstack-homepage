...
describe('AccordionTeaser', () => {
    ...
    const content = {
          ...
          templateEngine: 'tailwind spielt Stärken im schnellen Prototyping von Designs aus und schwächelt hingegen ein wenig wenn es um Skalier- und Modulierbarkeit geht.',
          codeRepo: 'Der Code für diese App ist in einem privaten Code Repository hinterlegt. Bitte nutzen Sie den mit github anmelden Button, um Zugang für das private Repo zu erhalten.'
        }
