...
// helpers: mockSocialiteUser(), createUser()

beforeEach(function () {
    // Simuliere authentifizierten Sanctum-Session-User
...
it('logs in existing user after OAuth callback', function () {
    ...
    $response->assertRedirectContains('http://localhost:5173/auth/callback?logged_in=true');
